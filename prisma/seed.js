...
async function main() {
  ...
  await prisma.category.create({ data: { name: 'Desarrollo de Software', description: 'Libros sobre lenguajes de programación, patrones de diseño y desarrollo web.' } });
  await prisma.category.create({ data: { name: 'Matemáticas y Ciencia', description: 'Textos de cálculo, física, álgebra lineal y ciencias naturales.' } });
  await prisma.category.create({ data: { name: 'Ciencia Ficción', description: 'Literatura fantástica, distopías y viajes espaciales.' } });
